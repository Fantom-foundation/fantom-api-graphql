...
// NewTokenTransactionList builds new resolvable list of ERC20 transactions.
func NewTokenTransactionList(tl *types.TokenTransactionList) *TokenTransactionList {
