...
//
// Solidity: function updateRate(uint256 _perSecond) returns()
func (_FMintRewardsDistribution *FMintRewardsDistributionTransactor) UpdateRate(opts *bind.TransactOpts, _perSecond *big.Int) (*types.Transaction, error) {
	return _FMintRewardsDistribution.contract.Transact(opts, "updateRate", _perSecond)
}

// UpdateRate is a paid mutator transaction binding the contract method 0x69ea1771.
//
// Solidity: function updateRate(uint256 _perSecond) returns()
func (_FMintRewardsDistribution *FMintRewardsDistributionSession) UpdateRate(_perSecond *big.Int) (*types.Transaction, error) {
	return _FMintRewardsDistribution.Contract.UpdateRate(&_FMintRewardsDistribution.TransactOpts, _perSecond)
}

// UpdateRate is a paid mutator transaction binding the contract method 0x69ea1771.
//
// Solidity: function updateRate(uint256 _perSecond) returns()
func (_FMintRewardsDistribution *FMintRewardsDistributionTransactorSession) UpdateRate(_perSecond *big.Int) (*types.Transaction, error) {
	return _FMintRewardsDistribution.Contract.UpdateRate(&_FMintRewardsDistribution.TransactOpts, _perSecond)
}
