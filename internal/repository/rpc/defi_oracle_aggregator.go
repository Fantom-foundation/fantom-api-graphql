...
func (_DefiOracleReferenceAggregator *DefiOracleReferenceAggregatorCaller) TokenPriceDecimals(opts *bind.CallOpts, _token common.Address) (uint8, error) {
	var (
		ret0 = new(uint8)
	)
	out := ret0
	err := _DefiOracleReferenceAggregator.contract.Call(opts, out, "tokenPriceDecimals", _token)
	return *ret0, err
}
...
//
// Solidity: function tokenPriceDecimals(address _token) view returns(uint8)
func (_DefiOracleReferenceAggregator *DefiOracleReferenceAggregatorSession) TokenPriceDecimals(_token common.Address) (uint8, error) {
	return _DefiOracleReferenceAggregator.Contract.TokenPriceDecimals(&_DefiOracleReferenceAggregator.CallOpts, _token)
}

// TokenPriceDecimals is a free data retrieval call binding the contract method 0xf7135354.
//
// Solidity: function tokenPriceDecimals(address _token) view returns(uint8)
func (_DefiOracleReferenceAggregator *DefiOracleReferenceAggregatorCallerSession) TokenPriceDecimals(_token common.Address) (uint8, error) {
	return _DefiOracleReferenceAggregator.Contract.TokenPriceDecimals(&_DefiOracleReferenceAggregator.CallOpts, _token)
}
