...
//
// Solidity: function tokens(uint256 ) view returns(address addr, bytes32 name, bytes32 symbol, string logo, uint256 decimals, bool isActive, bool canDeposit, bool canBorrow, bool canTrade, uint256 volatility)
...
// AddToken is a paid mutator transaction binding the contract method 0xc994399b.
//
// Solidity: function addToken(address _addr, address _aggregator, bytes32 _name, bytes32 _symbol, string _logo, uint256 _decimals, bool _isActive, bool _canDeposit, bool _canBorrow, bool _canTrade, uint256 _volatility) returns()
func (_DefiOracleReferenceAggregator *DefiOracleReferenceAggregatorTransactor) AddToken(opts *bind.TransactOpts, _addr common.Address, _aggregator common.Address, _name [32]byte, _symbol [32]byte, _logo string, _decimals *big.Int, _isActive bool, _canDeposit bool, _canBorrow bool, _canTrade bool, _volatility *big.Int) (*types.Transaction, error) {
	return _DefiOracleReferenceAggregator.contract.Transact(opts, "addToken", _addr, _aggregator, _name, _symbol, _logo, _decimals, _isActive, _canDeposit, _canBorrow, _canTrade, _volatility)
}

// AddToken is a paid mutator transaction binding the contract method 0xc994399b.
//
// Solidity: function addToken(address _addr, address _aggregator, bytes32 _name, bytes32 _symbol, string _logo, uint256 _decimals, bool _isActive, bool _canDeposit, bool _canBorrow, bool _canTrade, uint256 _volatility) returns()
func (_DefiOracleReferenceAggregator *DefiOracleReferenceAggregatorSession) AddToken(_addr common.Address, _aggregator common.Address, _name [32]byte, _symbol [32]byte, _logo string, _decimals *big.Int, _isActive bool, _canDeposit bool, _canBorrow bool, _canTrade bool, _volatility *big.Int) (*types.Transaction, error) {
	return _DefiOracleReferenceAggregator.Contract.AddToken(&_DefiOracleReferenceAggregator.TransactOpts, _addr, _aggregator, _name, _symbol, _logo, _decimals, _isActive, _canDeposit, _canBorrow, _canTrade, _volatility)
}

// AddToken is a paid mutator transaction binding the contract method 0xc994399b.
//
// Solidity: function addToken(address _addr, address _aggregator, bytes32 _name, bytes32 _symbol, string _logo, uint256 _decimals, bool _isActive, bool _canDeposit, bool _canBorrow, bool _canTrade, uint256 _volatility) returns()
func (_DefiOracleReferenceAggregator *DefiOracleReferenceAggregatorTransactorSession) AddToken(_addr common.Address, _aggregator common.Address, _name [32]byte, _symbol [32]byte, _logo string, _decimals *big.Int, _isActive bool, _canDeposit bool, _canBorrow bool, _canTrade bool, _volatility *big.Int) (*types.Transaction, error) {
	return _DefiOracleReferenceAggregator.Contract.AddToken(&_DefiOracleReferenceAggregator.TransactOpts, _addr, _aggregator, _name, _symbol, _logo, _decimals, _isActive, _canDeposit, _canBorrow, _canTrade, _volatility)
}
...
// UpdateToken is a paid mutator transaction binding the contract method 0x06dddf26.
//
// Solidity: function updateToken(address _addr, string _logo, uint256 _decimals, bool _isActive, bool _canDeposit, bool _canBorrow, bool _canTrade, uint256 _volatility) returns()
func (_DefiOracleReferenceAggregator *DefiOracleReferenceAggregatorTransactor) UpdateToken(opts *bind.TransactOpts, _addr common.Address, _logo string, _decimals *big.Int, _isActive bool, _canDeposit bool, _canBorrow bool, _canTrade bool, _volatility *big.Int) (*types.Transaction, error) {
	return _DefiOracleReferenceAggregator.contract.Transact(opts, "updateToken", _addr, _logo, _decimals, _isActive, _canDeposit, _canBorrow, _canTrade, _volatility)
}

// UpdateToken is a paid mutator transaction binding the contract method 0x06dddf26.
//
// Solidity: function updateToken(address _addr, string _logo, uint256 _decimals, bool _isActive, bool _canDeposit, bool _canBorrow, bool _canTrade, uint256 _volatility) returns()
func (_DefiOracleReferenceAggregator *DefiOracleReferenceAggregatorSession) UpdateToken(_addr common.Address, _logo string, _decimals *big.Int, _isActive bool, _canDeposit bool, _canBorrow bool, _canTrade bool, _volatility *big.Int) (*types.Transaction, error) {
	return _DefiOracleReferenceAggregator.Contract.UpdateToken(&_DefiOracleReferenceAggregator.TransactOpts, _addr, _logo, _decimals, _isActive, _canDeposit, _canBorrow, _canTrade, _volatility)
}

// UpdateToken is a paid mutator transaction binding the contract method 0x06dddf26.
//
// Solidity: function updateToken(address _addr, string _logo, uint256 _decimals, bool _isActive, bool _canDeposit, bool _canBorrow, bool _canTrade, uint256 _volatility) returns()
func (_DefiOracleReferenceAggregator *DefiOracleReferenceAggregatorTransactorSession) UpdateToken(_addr common.Address, _logo string, _decimals *big.Int, _isActive bool, _canDeposit bool, _canBorrow bool, _canTrade bool, _volatility *big.Int) (*types.Transaction, error) {
	return _DefiOracleReferenceAggregator.Contract.UpdateToken(&_DefiOracleReferenceAggregator.TransactOpts, _addr, _logo, _decimals, _isActive, _canDeposit, _canBorrow, _canTrade, _volatility)
}
